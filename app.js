...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      heroTitle1: 'Free Tap and Hold Image Maker.',
    ...
    es: {
      brandTitle: 'Toca y Mantén Kakushie Maker',
      ...
      heroTitle1: 'Creador de Imágenes Toca y Mantén Kakushie.',
      ...
      modalPrivacySec1Text: 'Toca y Mantén Kakushie Maker procesa todas las imágenes 100% localmente en tu navegador web. Tus archivos nunca se suben ni se almacenan en servidores externos.',
      ...
      modalTermsSec1Text: 'Al acceder y utilizar Toca y Mantén Kakushie Maker, aceptas cumplir con estos términos de servicio.',
    ...
    fr: {
      brandTitle: 'Appuie et Maintiens Kakushie Maker',
      ...
      heroTitle1: 'Générateur d\'Images Appuie et Maintiens Kakushie.',
      ...
      modalPrivacySec1Text: 'Appuie et Maintiens Kakushie Maker traite toutes vos images 100% localement dans votre navigateur. Vos fichiers ne sont jamais envoyés sur des serveurs externes.',
      ...
      modalTermsSec1Text: 'En utilisant Appuie et Maintiens Kakushie Maker, vous acceptez d\'être lié par ces conditions d\'utilisation.',
    ...
    pt: {
      brandTitle: 'Toque e Segure Kakushie Maker',
      ...
      heroTitle1: 'Gerador de Imagens Toque e Segure Kakushie.',
      ...
      modalPrivacySec1Text: 'O Toque e Segure Kakushie Maker processa todas as imagens 100% localmente no navegador. Seus arquivos nunca são enviados a servidores externos.',
      ...
      modalTermsSec1Text: 'Ao acessar e usar o Toque e Segure Kakushie Maker, você concorda com estes termos.',
      modalTermsSec2Title: '2. Uso permitido',
    ...
    ja: {
      ...
      heroTitle1: 'タップ＆長押し かくし絵メーカー',
      heroTitle2: 'Xのタイムラインで画像を隠す',
      heroDesc: 'タップ＆長押しは画像を透明なPNGに変換し、X/Twitterのタイムライン上では薄く見え、タップして長押しするとフルカラーで浮き出ます。',
    ...
    zh: {
      ...
      faq1Q: '什么是 点击长按 隐形图生成器？', faq1A: '这是一款免费在线浏览器工具，能将图片制作成在 X/Twitter 时间线上隐形/淡化、长按放大时瞬间呈现原图全彩效果的特殊透明 PNG。',
    ...
    ko: {
      ...
      heroTitle1: '탭 & 누르고 있기 카쿠시에 이미지 생성기',
      ...
      faq1Q: '탭 & 누르고 있기 카쿠시에 생성기란 무엇인가요?', faq1A: 'X 타임라인에서는 희미하게 보이고, 탭하여 누르고 있으면 원래 색상이 공개되는 투명 PNG를 생성해주는 무료 온라인 툴입니다.',
    ...
    ar: {
      brandTitle: 'صانع صور الضغط المطول المخفية',
      ...
      heroTitle1: 'صانع صور الضغط المطول المخفية',
